...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=a53792cc538bce51f2e6e20a63e3d831'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyAWveQWSw0UL2wQDJlfRFQZubcyr5CwBNA'

    SEARCH_ENGINE_ID = '02dd57f7724eb4da9'
